...
%type<node> opt_test term lambdef not_test and_expr pick_argument
%type<node> power or_test comparison expr xor_expr argument arglist
...
%type<node> if_stmt opt_IF_ELSE parameters fpdef opt_arglist
%type<suite> plus_stmt varargslist star_fpdef_COMMA star_argument_COMMA 
