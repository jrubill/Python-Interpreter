...
public:
    ...
    StringLiteral(StringLiteral *lhs, StringLiteral *rhs) : val(lhs->val + rhs->val){} 
    StringLiteral(std::string lhs, std::string rhs) : val(lhs + rhs){} 
    StringLiteral(StringLiteral *lhs, std::string rhs) : val(lhs->val + rhs) {} 
